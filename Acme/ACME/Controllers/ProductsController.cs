...
namespace ACME.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include ="ProductId,Name,Price")] Product product)
        {
            ...
            if (ModelState.IsValidField("Price")  //checks if the price field is valid
                && (product.Price < 0.01M)        // if so skips if not throws error
                || (product.Price > 1000M))
            {
            ...
            */
            ...
            product.ProductId = Guid.NewGuid();
            product.Name = Request["Name"];  // Magic string
            product.Price = Decimal.Parse(Request["Price"]);  // magic string
            */
